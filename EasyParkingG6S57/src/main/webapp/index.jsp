    ...
    <div class="container px-4 px-md-3 shadow p-3 mb-5 bg-body rounded">
        <div class="row align-items-lg-center">
            ...
            <div class="col-md-8 order-md-1 col-lg-7 text-center text-md-start">
                <h1 class="mb-3" id="titulo-principal">Easy Parking APP</h1>
...
<div class="container masthead-followup px-4 px-md-3">
        ...
        <div class="col-md-7">
            ...
            <div class="card-group">
                <div class="card">
                    ...
                    <div class="card-body">
                        <h5 class="card-title">David Sanabria</h5>
                ...
                <div class="card">
                    <img src="..." class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title">Alexander Reyes</h5>
                        <p class="card-text"><small class="text-muted">Last updated 3 mins ago</small></p>
                    </div>
                </div>
                <div class="card">
                    <img src="..." class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title">Daniel Gonzales</h5>
                        <p class="card-text"><small class="text-muted">Last updated 3 mins ago</small></p>
                    </div>
                </div>
                <div class="card">
                    ...
                    <div class="card-body">
                        <h5 class="card-title">Jorge Bonilla</h5>
                        <p class="card-text"><small class="text-muted">Last updated 3 mins ago</small></p>
                    </div>
                </div>
            </div>
    ...
    <section class="row mb-5 pb-md-4 align-items-center shadow p-3 mb-5 bg-body rounded">
        <div class="col-md-5">
            ...
            <p class="lead fw-normal">El aplicativo ha sido modelado en lenguaje de programación JAVA y MYSQL para la
                parte del backend y HTML, JSP,
                y JAVASCRIPT para la parte del frontend. Se compone de 3 objetos que son el parqueadero, el operador y
                el vehículo.</p>

        </div>
        <div class="col-md-7">
            <p>El primer objeto parqueadero tiene como atributos su identificación, el valor de la tarifa estándar por
                minuto para cada tipo de vehículo y la cantidad de lugares disponibles con los que cuenta el
                establecimiento.
                El segundo objeto Operador es la persona que interactua directamente con la aplicación registrando los
                ingresos
                y las salidas de los vehículos sus atributos son básicamente datos de identificación.
                El tercer objeto es el vehículo que es el originador de todo el proceso de registro desde que entra al
                parqueadero
                hasta que sale de él obteniendo como salida una data con su identificación hora de entrada hora de
                salida y
                la tarifa aplicada por el tiempo de uso.</p>
    ...
    <section class="row mb-5 pb-md-4 align-items-center shadow p-3 mb-5 bg-body rounded">
        <div class="col-md-5">
            ...
            <p class="lead fw-normal">El aplicativo cuenta con dos formularios con funciones CRUD (create, read, update
                & delete) para los objetos
        ...
        <div class="col-md-7">
            ...
            procedimiento para el uso del tablero de control
            escribir la placa del vehículo
            seleccionar el tipo de vehículo
            seleccionar el medio de pago
            dar click en el botón INGRESO

            en este momento se genera un ticket con la información del vehículo que ingresa

            al momento de la salida de un vehículo el usuario presenta su ticket de ingreso el operador
            digita el número de ticket
            presiona el botón salida

            aquí se genera una factura con la siguiente información

            toda la información es ingresada y consultada en una base de datos
        </div>
    </section>
    <section class="row mb-5 pb-md-4 align-items-center shadow p-3 mb-5 bg-body rounded">
        <div class="col-md-5">
        ...
        <div class="col-md-7">
            incluir loging para los operadores y el ingreso al aplicativo
        </div>
    </section>
    <section class="row mb-5 pb-md-4 align-items-center shadow p-3 mb-5 bg-body rounded">
        <div class="col-md-5">
        ...
        <div class="col-md-7">
            <p class=""> a Dios por ponernos en este camino</p>
            <p class="">a nuestra Familia por el apoyo y la paciencia</p>
            <p class="">a nuestros compañeros por su compromiso dedicación</p>
            <p class="">a la UIS por facilitar los medios de aprendizaje y por la calidad de los mismos</p>
            <p class="">a el MINTIC por ofrecer esta oportunidad de formación</p>
            <p class="">...y al cafe Sello Rojo por acompañarnos durante estas 600 horas de esfuerzos</p>
        </div>
    </section>
</div>
</body>
